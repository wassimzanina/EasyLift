report 50100 "EasyLift Sales - Invoice"
{
    WordLayout = './Reports/EasyLiftSalesInvoice.docx';
    Caption = 'EasyLift Sales - Invoice';
    DefaultLayout = Word;
    ...
    dataset
    {
        dataitem(Header; "Sales Invoice Header")
        {
            ...
            column(Certificate_Reference_No_; "Certificate Reference No.")
            {
            }
            column(Certificate_Reference_No_Lbl; FieldCaption("Certificate Reference No."))
            {
            }
